      ...
      <Container>
        <Navbar.Collapse id="responsive-navbar-nav" className='justify-content-center'>
          <Nav className="collapse-custom ">
            <Nav.Link className={(props.page=="home") ? " active" : ""} href="home" style={{color:"white"}}>Trang chủ</Nav.Link>
            <Nav.Link href="#gioithieu" style={{color:"white"}}>Giới thiệu</Nav.Link>
            <Nav.Link className={(props.page=="newsFeed") ? " active" : ""} href="newsFeed" style={{color:"white"}}>Bảng tin</Nav.Link>
            ...
            <Nav.Link className={(props.page=="vlog") ? " active" : ""} href="vlog" style={{color:"white"}}>Vlog</Nav.Link>
